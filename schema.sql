...
('Databases', 'In relational databases, which Normal Form eliminates transitive functional dependencies?', '["First Normal Form (1NF)", "Second Normal Form (2NF)", "Third Normal Form (3NF)", "Boyce-Codd Normal Form (BCNF)"]', 2, '3NF requires that every non-prime attribute is non-transitively dependent on every candidate key.'),
